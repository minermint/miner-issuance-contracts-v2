...
describe("Issuance", () => {
    ...
    describe("permitting issuance", () => {
        it("should add a new admin as owner", async () => {
            ...
            expect(await issuance.hasRole(await issuance.ADMIN(), alice)).to.be
                .true;
        });
        ...
        it("should add a new admin as admin", async () => {
            ...
            expect(await issuance.hasRole(await issuance.ADMIN(), bob)).to.be
                .true;
        });
        ...
        it("should add an issuer", async () => {
            ...
            expect(await issuance.hasRole(await issuance.ISSUER(), issuer)).to
                .be.true;
        });
        ...
        it("should remove an issuer", async () => {
            ...
            expect(await issuance.hasRole(issuance.ISSUER(), issuer)).to.be
                .false;
        });
